...
local netupinfo = lain.widget.net({
    settings = function()
        ...
        widget:set_markup(markup.fontfg(theme.font, "#e54c62", helpers.format_number(net_now.sent, 1) .. " "))
        netdowninfo:set_markup(markup.fontfg(theme.font, "#87af5f", helpers.format_number(net_now.received, 1) .. " "))
    end
})
...
function theme.at_screen_connect(s)
   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
    ...
    -- Tags
    -- sharedtags(awful.util.tagnames, s, awful.layout.layouts[1])
